...
export function apiAuthRefreshPost(http: HttpClient, rootUrl: string, params: ApiAuthRefreshPost$Params, context?: HttpContext): Observable<StrictHttpResponse<AuthResponse>> {
